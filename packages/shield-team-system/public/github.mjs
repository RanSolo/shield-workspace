export {
  ...
  GITHUB_ISSUE_OBSERVATION_CONTRACT_VERSION,
  GITHUB_ISSUE_OBSERVATION_SCHEMA_VERSION,
  GITHUB_ISSUE_OBSERVER_MAX_BYTES,
  GITHUB_ISSUE_OBSERVER_MAX_DEPTH,
  GITHUB_ISSUE_OBSERVER_TIMEOUT_MS,
