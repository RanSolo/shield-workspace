...
2. Add a bounded mission runner that records specialist-packet state, enforces
   packet lineage and stop triggers, and preserves evidence-bound, non-numeric
   specialist iteration before human escalation.
