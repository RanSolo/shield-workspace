...
CREATE TABLE "SocialMediaLink" (
    "id" TEXT NOT NULL,
    "featuredEmbed" TEXT DEFAULT 'add your embed under settings',
...
CREATE TABLE "Post" (
    ...
    "imageBlurhash" TEXT DEFAULT 'data:image/pngbase64,',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "SocialMediaLink" ADD CONSTRAINT "SocialMediaLink_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "Site"("id") ON DELETE CASCADE ON UPDATE CASCADE;
